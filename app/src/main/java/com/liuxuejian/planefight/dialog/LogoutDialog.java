...
import com.liuxuejian.planefight.base.BaseFragmentDialog;
...
public class LogoutDialog extends BaseFragmentDialog {
    ...
    public FinishGameListener mListener;

    public void setListener(FinishGameListener listener) {
